...
<div style="position:absolute;left:214px;top:117px;width:278px;padding:var(--pad,12px 15px);background:color-mix(in srgb,#8b5cf6 8%,var(--surface,#fff));border:1px solid color-mix(in srgb,#8b5cf6 32%,var(--border,#e7e5e4));border-radius:13px"><div style="font:600 10px/1 'DM Mono',monospace;letter-spacing:.08em;text-transform:uppercase;color:#8b5cf6">Naming</div><div style="margin-top:6px;font:600 14.5px/1.2 'DM Sans',sans-serif;color:var(--ink,#1c1917)">DotNS · .dot name + resolver</div></div>
