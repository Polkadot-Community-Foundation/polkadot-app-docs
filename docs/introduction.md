...
updates the `.dot` name that should load it. The gateway then resolves the name
...
=== "I am a user"
    ...
    1. Install the app: [Android (Play)](https://play.google.com/store/apps/details?id=io.pcf.polkadotapp),
...
=== "I am a developer"
    ...
    2. Build and ship a dApp: [Build & publish a dApp](guides/build-and-publish.md)
       and [Register a .dot name](guides/register-a-dot-name.md).
